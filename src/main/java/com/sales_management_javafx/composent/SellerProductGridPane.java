...
//        FXMLLoader sellerProductBoxLoader = new FXMLLoader(SalesApplication.class.getResource("fxml/seller/sellerProductBox.fxml"));
//        StackPane stackPane;
//        try {
//            stackPane = sellerProductBoxLoader.load();
//            SellerProductBoxController sellerProductBoxController = sellerProductBoxLoader.getController();
