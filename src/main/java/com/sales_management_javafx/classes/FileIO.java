...
public class FileIO {
    public static <T> void writeTo(String filename, T o){
        try(FileOutputStream fileOutputStream = new FileOutputStream("C:\\Users\\ASUS\\IdeaProjects\\GV-F\\src\\main\\resources\\com\\sales_management_javafx\\data\\"+filename)) {
    ...
    public static Object readFrom(String filename) {
        try (FileInputStream fileInputStream = new FileInputStream("C:\\Users\\ASUS\\IdeaProjects\\GV-F\\src\\main\\resources\\com\\sales_management_javafx\\data\\"+filename);
